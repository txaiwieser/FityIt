...
////        let leftContainer = SKSpriteNode(color: SKColor.blackColor(), size: conSize1)
////        let rightContainer = SKSpriteNode(color: SKColor.blackColor(), size: conSize2)
//
//        let leftContainer = SKSpriteNode(color: SKColor.clear, size: conSize1)
//        let rightContainer = SKSpriteNode(color: SKColor.clear, size: conSize2)
//
//        
...
//        let l = LPRFixedWidthLabelNode(text: text)
//        l.truncationMode = .scale
//        l.fontName = DEFAULT_FONT_NAME_BOLD
//        l.fontSize = fontSize
//        l.horizontalAlignmentMode = .center
//        l.verticalAlignmentMode = .center
//        return l
